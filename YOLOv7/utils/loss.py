    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            for i, pi in enumerate(p):
                ...
                # from_which_layer.append(torch.ones(size=(len(b),)) * i)             # REMOVED
                from_which_layer.append((torch.ones(size=(len(b),)) * i).to('cuda'))  # ADDED
            ...
            fg_mask_inboxes = fg_mask_inboxes.to(torch.device('cuda'))        # ADDED
